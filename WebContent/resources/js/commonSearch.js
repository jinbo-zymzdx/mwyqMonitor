...
;(function($, window, document, undefined) {
	$.fn.commonSearch = function(options, callback) {
		...
		$this.append('<div class="yixuan"><table><tr class="new"><td>\
				<p class="part-title-icon-bg part-title-icon-bg-blue">\
				<i class="glyphicon glyphicon-compressed"></i></p></td><td width="80" align="left"><strong>'
				+ settings.title + '</strong></td><td><div class="yixuanNavList"></div></td></tr></table></div>')
