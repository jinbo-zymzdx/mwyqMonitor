...
<body class="topic" style="font-family: MENKSOFT2007">
	...
	<div id="container" class="container" style="float: left">
		...
		<div>
			...
			<table>
				<tr>
					<td rowspan="4" style="vertical-align: top;"><div
							class="col-md-3"
							style="height: 100%; margin-left: 60px; margin-top: 10px;">
							<div class="meng">
<!-- 								<input type="text" -->
<!-- 									style="height: 350px; margin-top: auto; width: 50px; float: left; writing-mode: tb-lr;" /> -->
<!-- 								<input type="button" value="搜索" -->
<!-- 									style="height: 80px; width: 50px; background-color: #cdcdcd; float: left" /> -->
						...
						<table>
							<tr>
								<td><div class="col-md-13"
										style="width: 697px; height: 400px;">
										<div class="new-des  bd">
											<div class="panel panel-default">
												<div class="panel-heading"
													style="padding: 5px 5px; height: 50px;">
													<div class="main-news-title">
														<span id="mainnew_title"> 一共有： <span id="huatishu"
												...
												<div class="panel-body1 meng"
													style="height: 85%; word-break: keep-all;">

													<c:forEach items="${topicNews }" var="topicNews">
														<c:choose>
															<c:when test="${topicNews.lang_type == 'cn'}">
																<div
																	style="writing-mode: lr-tb; overflow-x: hidden; overflow-y: scroll; width: 685px; height: 100%;">
																	<p>
																		<fmt:formatDate value="${topicNews.news_time}"
																			type="date" pattern="yyyy-MM-dd" />
																	</p>
																	<p>${topicNews.news_author}</p>
																	<p id="huatixia" class="huatixia"
																		style="height: 100%; break-word: keep-all; width: 685;">
							...
							<tr>
								<td><div class="col-md-13"
										style="width: 500px; height: 400px; width: 697px;">
										<div class="new-des" style="height: 100%; width: 100%">
											<div class="panel panel-default">
												<div class="panel-heading"
													style="padding: 5px 5px; height: 50px;">
													<div class="main-news-title">
												...
												<!-- 	<div onclick="getHotTopics(1)">上一页</div>
							                 	<div onclick="getHotTopics(2)">下一页</div> -->
												<div class="panel-body1 meng"
													...
													<c:forEach items="${topicAllNews }" var="topicAllNews">
														<div class="newslist"
															style="height: 100%; word-break: keep-all;">
															<p id="newstitle" style="height: auto;">
																<a style="height: auto;"
																	href="<%=request.getContextPath()%>/topic/${topicAllNews.news_id }/newsContentEntityRelation">
																	${topicAllNews.news_title }</a> <small id="time"
																	class="pull-right text-muted meng"
																	style="border-right: 1px dotted #333333; height: 100%; text-align: right; width: 30px;">
																	<fmt:formatDate value="${topicAllNews.news_time}"
																		type="date" pattern="yyyy-MM-dd" />
																</small>
															</p>
					...
					<td><div class="col-md-14"
							style="width: 370px; height: 250px; margin-top: 0px;">
							<div class="new-des  bd">
								<div class="panel panel-default">
									<div class="panel-heading ">人物统计</div>
									<div id="person1" class="panel-body1" style="height: 200px;"></div>
								</div>
							</div>
						</div></td>
				</tr>
					...
					<td><div class="col-md-13"
							...
							<div class="new-des  bd">
								<div class="panel panel-default">
									...
									<div id="place1" class="panel-body1" style="height: 200px;"></div>
								</div>
							</div>
						</div></td>
				</tr>
					...
					<td><div class="col-md-14"
							...
							<div class="new-des  bd">
								<div class="panel panel-default">
									...
									<div id="org1" class="panel-body1" style="height: 200px;"></div>
								</div>
							</div>
						</div></td>
				</tr>
				...
				<tr>
					...
					<td>
						<div class="col-md-14 bd" style="width: 350px; display: none;">
							<div class="new-des  bd">
								<div class="panel panel-default">
									<div class="panel-heading ">新闻趋势</div>
									<div id="bo1" class="panel-body1"></div>
								</div>
							</div>
						</div>
					</td>
					<td>
						<div class="col-md-14 bd" style="width: 350px; display: none;">
							<div class="new-des  bd">
								<div class="panel panel-default">
									<div class="panel-heading">话题地图</div>
									<div id="map1" class="panel-body1"></div>
								</div>
							</div>
						</div>
					</td>
		...
		<!-- <div class="row space29"
			style="padding-left: 20px; height: 71%; margin-top: 2px;">
			row 1 begins
			
			  <div class="col-md-15 meng bd" style="width: 1.5%;float: left;margin-left: 5px; margin-right: 5px;">
	  <h3 class="page-header">新京报快讯</h3>
	 </div>
			<div class="col-md-10"
				style="width: 96.5%; height: 100%; float: left;">
		...
		<div id="modaldiv" class="table-responsive modal fade in"
			style="display: none; position: fixed; top: 50%; left: 50%; z-index: 1050; max-height: 300px; overflow: auto; width: 500px; margin: -250px 0 0 -280px; background-color: #ffffff; border: 1px solid #999; border: 1px solid rgba(0, 0, 0, 0.3); border: 1px solid #999; -webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px; -webkit-box-shadow: 0 3px 7px rgba(0, 0, 0, 0.3); -moz-box-shadow: 0 3px 7px rgba(0, 0, 0, 0.3); box-shadow: 0 3px 7px rgba(0, 0, 0, 0.3); -webkit-background-clip: padding-box; -moz-background-clip: padding-box; background-clip: padding-box;">
			<form id="langTypeForm" action="/mwyqMonitor/topic/chooselang" method="POST">
				...
				<div class="modal-body">
					<table class="table table-bordered table-hover">
						<tr>
							<td style="text-align: center;">蒙文:&nbsp;&nbsp; <input
								type="radio" checked="checked" id="mengradio" name="langtype"
								value="meng" />
							</td>
							<td style="text-align: center;">中文： <input type="radio"
								id="cnradio" name="langtype" value="cn" /></td>
						</tr>
					</table>
				</div>
				<div class="modal-footer">
					<input type="botton" class="btn btn-success" value="提交"
						onClick="chooselang()" style="width: 60px;"><a href="#"
