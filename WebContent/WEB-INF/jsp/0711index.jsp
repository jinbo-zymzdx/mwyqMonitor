...
<body>
	...
	<div id="container" class="container bd" style="float:right">
		...
		<ul class="nav nav-justified bd" style="height:60px;padding-left:50px;">
			...
			<li style="width:200px;"><a href="/baidu/" target="_blank">&nbsp;&nbsp;搜 &nbsp;&nbsp;索 &nbsp;&nbsp;</a></li>
		</ul>

		<div class="row space29" style="padding-left:100px;margin-top:10px;">
			<!-- 搜索栏 -->
			
			<div style="float:left;height:500px;width:10%;margin-top:50px;">
			<!-- 
				<form action="/mwyqMonitor/query/getResByKeyWord" method="get" onSubmit="return test();">
					<div style="float:left;margin-right:10px;">
						<input type="text" name="keyword" id="keyword"
							style="height:400px;width:50px;writing-mode: tb-lr;font-family:menksoft2007" />
					</div>
					<div style="margin-top:10px;">
						<input type="submit" value="搜索" style="height:80px;width:50px;background-color:#cdcdcd;" />
					</div>
				</form>
				 -->
			</div>
			...
			<!-- 地图 -->
			<div class="col-md-4" style="height:600px;width:40%;float:left;margin-right:10px;">
				<div class="new-des bd">
					<div class="panel panel-default">
						<div class="panel-heading ">话题地图</div>
						<div id="map" class="panel-body" style="height:550px;width:100%;"></div>
					</div>
				</div>
			</div>
			<!-- 新闻趋势和实体 -->
			<div class="col-md-4" style="height:600px;width:40%;float:left;">
				<div class="col-md-5" style="height:320px;width:100%;float:left">
					<div class="new-des  bd">
						<div class="panel panel-default">
							<div class="panel-heading ">新闻趋势</div>
							<div id="bo" class="panel-body"></div>
						</div>
					</div>

				</div>
				<div class="col-md-8" style="height:300px;width:100%;float:left">
					<div class="col-md-1" style="height:100%;">
						<div class="new-des  bd">
							<div class="panel panel-default">
								<div class="panel-heading ">地点统计</div>
								<div id="place" class="panel-body"></div>
							</div>
						</div>
					</div>
					<div class="col-md-1">
						<div class="new-des  bd">
							<div class="panel panel-default">
								...
								<div id="person" class="panel-body"></div>
							</div>
						</div>
					</div>
					<div class="col-md-1">
						<div class="new-des  bd">
							<div class="panel panel-default">
								...
								<div id="org" class="panel-body"></div>
							</div>
						</div>
					</div>
		...
		<div class="row space30  meng bd" style="padding-left: 2%; margin-bottom: 50px;">
			<div class="bottomRealContent" style="margin-bottom: 10px;">
				<div class="panel-heading meng">热门话题</div>
				<div id="hot_topic_div" style="border: 1px solid; margin-bottom: 8px;">
					<c:forEach items="${topicList}" var="topic">
						<div class="bottomContentBox"
							...
							<div class="huati">
								<p style="writing-mode: tb-lr; writing-mode: vertical-lr; font-size: 20px; height: 450px; width: auto; border-right: 1px dashed #cdcdcd;">
									<a style="writing-mode: lr-tb; writing-mode: lr-vertical; color: red">${topic.news_count}</a>
									<a href="<%=request.getContextPath() %>/topic/${topic.topic_id}/news"
										style="font-size: 20px; width: auto; height: 450px;">${topic.topic_name}
									</a>
								</p>
							</div>
							<p class="show-line-3" style="height:450px;margin-top:5px;width:200px;font-size:16px;">
								${topic.news_content} 
								alert(${topic.news_content})
								console.log(${topic.news_content});
								<small class="pull-right text-muted" style="font-size: 12px;">
