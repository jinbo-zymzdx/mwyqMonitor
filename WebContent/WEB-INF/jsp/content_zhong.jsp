...
<body>
	...
	<div id="p_main">
		<div id="con" class="con">
			<div id="contentinfo">
				关于 <h1>${requestScope.key_words }</h1> 的信息为您搜索如下:
			</div>
			...
			<div id="content">
				...
				<div class="pss">
				    <h1>
						<!-- <a class="title_a_label" href="http://${advice.crawlSource}">${advice.newsTitle}	</a> -->
						<a href="getContent_Dan_Zhong?news_title=${advice.newsTitle}">${advice.newsTitle}</a>
						
					</h1>
					<div class="des">
						${fn:substring(advice.newsContent,0,110)}${'...'} 
						<div>		
							<a href="http://${advice.crawlSource}">${advice.crawlSource}</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;		
							${advice.newsTime}
						</div>
					</div>
				</div>
