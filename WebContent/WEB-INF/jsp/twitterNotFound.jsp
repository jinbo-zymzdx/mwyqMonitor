...
<head>
    ...
    <title >民文舆情汇聚与监测系统 — twitter</title>
...
<div id="wrapper">
    ...
    <!-- 右侧主体部分 -->
    <div id="page-wrapper">
        <div class="row" style="padding-top:25px;margin-top:50px">
        	<div class="alert alert-danger alert-dismissible fade in" role="alert">
        		<h3>找不到与"${word} "相关的twitter！</h3>
        		<p style="font-size:14px; line-height:26px;">可能原因是："${word}"不是一个作者或由于网络原因导致返回结果丢失</p>
        	</div>
        </div>
    </div>
    <!-- /#page-wrapper -->
